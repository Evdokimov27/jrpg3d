            ...
            foreach (var t in itemUsed.onUseActions)
            {
                ...
                switch (t.actionType)
                {
                    ...
                    case RPGItem.OnUseActionType.learnAbility:
                        if (RPGBuilderUtilities.isAbilityKnown(t.abilityID))
                        {
                            ErrorEventsDisplayManager.Instance.ShowErrorEvent("This ability is already known", 3);
                            isConsumed = false;
                        }
                        else
                        {
                    ...
                    case RPGItem.OnUseActionType.learnRecipe:
                        if (RPGBuilderUtilities.isRecipeKnown(t.recipeID))
                        {
                            ErrorEventsDisplayManager.Instance.ShowErrorEvent("This recipe is already known", 3);
                            isConsumed = false;
                        }
                        else
                        {
                    ...
                    case RPGItem.OnUseActionType.learnResourceNode:
                        if (RPGBuilderUtilities.isResourceNodeKnown(t.resourceNodeID))
                        {
                            ErrorEventsDisplayManager.Instance.ShowErrorEvent("This resource node is already known", 3);
                            isConsumed = false;
                        }
                        else
                        {
                    ...
                    case RPGItem.OnUseActionType.learnBonus:
                        if (RPGBuilderUtilities.isBonusKnown(t.bonusID))
                        {
                            ErrorEventsDisplayManager.Instance.ShowErrorEvent("This bonus node is already known", 3);
                            isConsumed = false;
                        }
                        else
                        {
